        ...
        <div className="contact-items">
          ...
          <div className="contact-rows">
            ...
            <div className="delivery">
              <p>
              <a target="_blank" rel="noopener noreferrer" href="https://www.grubhub.com/restaurant/chada-thai-2005-e-17th-ave-denver/321295">
                <img
                  className="grubhub"
                  src={grubhub}
                  height="90px"
              ...
              <p>
                <a target="_blank" rel="noopener noreferrer" href="https://www.doordash.com/store/chada-thai-denver-914823/">
                  <img
                    className="doordash"
                    src={doordash}
                    height="90px"
